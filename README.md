...
| 2 | [02_servidor_web.png](screenshots/02_servidor_web.png) | Inicialización del servicio web Apache local en Kali Linux y configuración del archivo `index.html` modificado. |
